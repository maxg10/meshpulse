...
**Author:** Mariusz "Max" Gieparda
**Contact:** mgieparda@yahoo.com
**GitHub:** github.com/maxg10
...
**Docker (TCP-only):**
```bash
# Quick start with tracker IP:
docker run -e TRACKER_HOST=192.168.1.103 -p 80:80 -p 8765:8765 -v mapper-data:/app/data maxg10/meshtastic-mapper

# Or with docker-compose:
cp .env.example .env
# Edit .env and set TRACKER_HOST
docker compose up -d
```
